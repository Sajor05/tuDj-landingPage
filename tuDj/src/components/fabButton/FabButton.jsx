...
import { FaWhatsapp, FaInstagram, FaEnvelope, FaUser, FaTimes } from 'react-icons/fa';
...
export const FabButton = () => {
  ...
  return (
    <div ref={modalRef} className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-4">
      
      <div className={`flex flex-col gap-3 transition-all duration-300 ${
          isOpen ? 'opacity-100 translate-y-0 visible mr-0.5' : 'opacity-0 translate-y-10 invisible'
        }`}>
        
        <a href="https://wa.me/5491132022228" target='_blank' className="flex items-center gap-2 group">
        ...
        <a href="https://www.instagram.com/tudj.arg/" target='_blank' className="flex items-center gap-2 group">
          <span className="bg-white text-gray-800 px-2 py-1 rounded shadow-md text-sm font-semibold opacity-0 group-hover:opacity-100 transition-opacity">
            Instagram
          </span>
