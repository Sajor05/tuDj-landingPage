...
export const Footer = () => {
  return (
    <footer className="h-150 flex justify-center bg-black text-white px-5 relative z-10">
      ...
      <div className="flex flex-row gap-8">
        <div className="flex flex-col w-60 gap-10">
          <div className="flex flex-col gap-1">
            ...
            <input type="text" id="name" required="true" name="name" className="bg-white text-black p-1.5 rounded-sm"/>        
          </div>
          <div className="flex flex-col gap-1">
            <label htmlFor="telefono" className="font-semibold text-[19px]">Teléfono</label>
            <input type="text" id="telefono" required="true" name="telefono" className="bg-white text-black p-1.5 rounded-sm"/>
          </div>
        </div>
        <div className="flex flex-col w-60 gap-10">
          <div className="flex flex-col gap-1">
            <label htmlFor="email" className="font-semibold text-[19px]">Email</label>
            <input type="email" id="email" required="true" name="email" className="bg-white text-black p-1.5 rounded-sm"/>
          </div>
          <div className="flex flex-col gap-1">
            <label htmlFor="consult" className="font-semibold text-[19px]">Consulta</label>
            <textarea id="consult" required="true" className="bg-white text-black p-1.5 rounded-sm" rows={5} cols={30}></textarea>
          </div>
        </div>
      </div>
